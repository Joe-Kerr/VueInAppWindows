...
const win2 = {
	...
	template: `
		<div>
			...
			<p>Speaking of funcs: <a href="#" @click="funcs.openChild({id:'demo-window-1', x: 1, y:1})">This will open a child window.</a>  Close the parent window and see what happens...</p>
		</div>
	`
};
